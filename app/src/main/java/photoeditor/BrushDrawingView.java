...
public class BrushDrawingView extends View {
    ...
    private float mBrushSize = 25f;
    private float mBrushEraserSize = 50f;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("onSizeChanged", e.getMessage());
        }
    }
    ...
    private void touchStart(float x, float y) {
        ...
        mPath.quadTo(mTouchX, mTouchY, (mTouchX + 0.1f + mTouchX) / 2, (mTouchY + 0.1f + mTouchY) / 2);
    }
